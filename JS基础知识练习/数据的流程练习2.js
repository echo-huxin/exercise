...
// let allGirl = [];
// for (let i = 0; i < students.length; i++) {
//   students[i].sex === "女" && allGirl.push(students[i].name);
// }
// console.log(allGirl);
// 得到所有年龄在25岁以下的女生（新数组）
// let newAll = [];
// for (let i = 0; i < students.length; i++) {
//   students[i].age < 25 && newAll.push(students[i].name);
// }
// console.log(newAll);
// 得到所有姓陈的学生（新数组）
// let newAll = [];
// for (let i = 0; i < students.length; i++) {
//   students[i].name[0] === "梁" && newAll.push(students[i].name);
// }
// console.log(newAll);
// 得到所有电话号码以1结尾的学生（新数组）
// let newAll = [];
...
// for (let i = 0; i < students.length; i++) {
//   temp = students[i].tel;
//   temp[temp.length - 1] === "1" && newAll.push(students[i].name);
// }
// console.log(newAll);
// 得到所有学生姓名组成的数组（新数组）
// let newAll = [];
...
for (let i = 0; i < students.length; i++) {
  students[i].id === 7969977 && console.log("找到了");
}
// 是否包含年龄大于28岁的男生
